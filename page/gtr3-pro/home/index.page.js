...
Page({
    build() {
        ...
        //Example 4
        //issue: Although the addPoint function is not documented, it somehow works.
        // But for me it is expected it should put only dots to the canvas, but instead it outputs a dots connected with a lines
        // , see https://i.imgur.com/FsDutRi.png
